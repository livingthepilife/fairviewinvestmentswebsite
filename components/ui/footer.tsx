        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">Fairview Investment Club: The premier option for all things investing.</div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              ...
              <li className="ml-4">
                <Link href="https://www.instagram.com/fairviewinvestments/" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Instagram">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; Fairview Investment Club. All rights reserved.</div>
